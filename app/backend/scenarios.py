...
DEFAULT_TRIPLETS: list[Triplet] = [
    ...
    Triplet(
        ...
        network=Component(
            id="subnet-1-portal",
            label="Subnet 10.0.1.0/24 (Portal)",
            domain=Domain.networking,
            component_type="subnet",
            x=35, y=75,
            metadata={"cidr": "10.0.1.0/24", "vlan": 101},
    ...
    Triplet(
        ...
        network=Component(
            id="subnet-1-inv",
            label="Subnet 10.0.1.0/24 (Inventory)",
            domain=Domain.networking,
            component_type="subnet",
            x=35, y=85,
            metadata={"cidr": "10.0.1.0/24", "vlan": 101},
